...
void Motor1_GPIO_Init(void)//电机驱动1 IO初始化函数
{
  ...
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW ;//设对应引脚IO操作速度
	...
	GPIO_InitStruct.Pin = GPIO_PIN_12;//设定对应引脚IO编号
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;//设定对应引脚IO为输出模式
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW ;//设对应引脚IO操作速度
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12, GPIO_PIN_RESET);//设定对应引脚电平状态
	HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);//初始化对应引脚IO
	
	
	GPIO_InitStruct.Pin = GPIO_PIN_6;//设定对应引脚IO编号 
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;//设定对应引脚IO为输出模式
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW ;//设对应引脚IO操作速度
	HAL_GPIO_WritePin(GPIOC, GPIO_PIN_6, GPIO_PIN_RESET);//设定对应引脚电平状态
	HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);//初始化对应引脚IO
...
void Motor2_GPIO_Init(void)//电机驱动2 IO初始化函数
{
  ...
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW ;//设对应引脚IO操作速度
	...
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;//设定对应引脚IO为输出模式
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW ;//设对应引脚IO操作速度
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_13, GPIO_PIN_RESET);//设定对应引脚电平状态
	HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);//初始化对应引脚IO
}
...
void Motor3_GPIO_Init(void)//电机驱动3 IO初始化函数
{
  ...
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW ;//设对应引脚IO操作速度
	...
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;//设定对应引脚IO为输出模式
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW ;//设对应引脚IO操作速度
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_14, GPIO_PIN_RESET);//设定对应引脚电平状态
	HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);//初始化对应引脚IO
}
...
void Motor4_GPIO_Init(void)//电机驱动4 IO初始化函数
{
  ...
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW ;//设对应引脚IO操作速度
	...
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;//设定对应引脚IO为输出模式
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW ;//设对应引脚IO操作速度
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_15, GPIO_PIN_RESET);//设定对应引脚电平状态
	HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);//初始化对应引脚IO
